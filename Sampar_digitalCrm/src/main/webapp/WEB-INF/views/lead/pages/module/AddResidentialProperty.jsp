...
<section class="content" ng-init="getDataOnLoad()">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<label> <input type="radio" name="SellRent"
								...
								class="flat-red saletype" required="required"> Rent Out
								Property
							</label>
						</div>
 ...
 -->
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control input-sm"
									...
									placeholder="Property/Society   Name" required="required">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" placeholder="price" ng-model="resident.price"
						...
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									ng-model="resident.area" class="form-control input-sm"
									required="required" placeholder="Area"> <span
									class="input-group-addon" style="width: 50%;"> <select
									ng-model="resident.areatype" class="form-control input-sm"
									required="required"
									style="height: -webkit-fill-available; min-height: 16px; padding: 0; border: 0;">
		...
		<div class="row">
			<div class="col-md-1">
				<div class="form-group">
					<b><i class="fa fa-plus btn btn-primary btn-xs" ng-show="plus"
						ng-click="showmore()"></i></b> <b><i
						class="fa fa-minus btn btn-danger btn-xs" ng-show="minus"
						ng-click="hidemore()"></i></b>
				</div>
