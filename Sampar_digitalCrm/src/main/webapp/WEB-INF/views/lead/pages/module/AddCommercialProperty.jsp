...
<section class="content" ng-init="getDataOnLoad()">
	...
	<div class="box box-primary">
		<div class="box-header with-border">
			<h5>
				<i class="fa fa-building-o text-red"></i>&nbsp;&nbsp;<b>Add
			...
			<form name="myForm">
				<div class="row">
					...
					<div class="col-md-10">
						<div class="form-group">
							...
							<label> <input type="radio" name="r3" value="Office"
								id="propertytype" class="flat-red" checked> Office
							</label> &nbsp;&nbsp;&nbsp; <label> <input type="radio" name="r3"
								value="Shop" id="propertytype" class="flat-red"> Shop
							</label> &nbsp;&nbsp;&nbsp; <label> <input type="radio" name="r3"
								value="Industrial_Lands_Plots" id="propertytype"
								class="flat-red"> Land/Inst.land
							</label> &nbsp;&nbsp;&nbsp; <label> <input type="radio" name="r3"
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<label> <input type="radio" name="owner" value="Broker"
								id="owner" class="flat-red" checked> Broker
							</label> &nbsp;&nbsp;&nbsp; <label> <input type="radio"
								name="owner" value="Individual" id="owner" class="flat-red">
								Individual
							</label>
						</div>
					</div>
				...
				<div class="row">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control input-sm"
									ng-model="commercial.projectname"
									placeholder="Society/Project Name" required="required">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" placeholder="Owner mobile" maxlength="10"
									ng-model="commercial.ownerMobile" class="form-control input-sm"
									required="required">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" placeholder="Asking Price"
									ng-model="commercial.price" class="form-control input-sm"
									required="required"> <span class="input-group-addon"
									style="width: 40%;"> <select
									ng-model="commercial.pricein" class="form-control input-sm"
									required="required"
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-inr"></i></span>
								<input type="text" placeholder="Area" ng-model="commercial.area"
									class="form-control input-sm" required="required"> <span
									class="input-group-addon" style="width: 40%;"> <select
									ng-model="commercial.areatype" class="form-control input-sm"
									required="required"
									style="height: -webkit-fill-available; min-height: 16px; padding: 0; border: 0;"
									required="required">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" placeholder="Maintainence"
									ng-model="commercial.maintenance" class="form-control input-sm"
									required="required"> <span class="input-group-addon"
									style="width: 40%;"> <select
									ng-model="commercial.maintenancetype"
						...
						<div class="col-md-3" ng-init="getDataOnLoad1()">
					<div class="form-group">
						<label>City</label>
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-building"></i></span>
							<select class="form-control input-sm" ng-model="locality.cityid"
								placeholder="City" required="required" ng-change="getLocality()">
								<option value="{{city.cityid}}" ng-repeat="city in cityList">{{city.cityname}}</option>
							</select>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user"></i></span>
							<select ng-model="resident.localityid"
								class="form-control input-sm" required="required">

								<option value="{{locality.localityid}}"
									ng-repeat="locality in localityList">{{locality.localityname}}</option>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-building"></i></span>
							<select class="form-control input-sm" ng-model="society.sectorId"
								placeholder="Sector" required="required"
								ng-change="getSociety()">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user"></i></span>
							<select ng-model="resident.societyId"
								class="form-control input-sm" required="required">

								<option value="{{society.societyid}}"
									ng-repeat="society in societyList">{{society.societyName}}</option>
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<label style="margin-top: 30px;" ng-show="plus"
								ng-click="showmore()"><i
								class="fa fa-plus btn btn-primary btn-xs">&nbsp;Add More</i> </label> <label
								style="margin-top: 30px;" ng-show="minus" ng-click="hidemore()"><i
								class="fa fa-minus btn btn-danger btn-xs">&nbsp;view Less</i> </label>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="date" class="form-control input-sm" id="doa"
									ng-model="doa" min="{{ doa |date :'yyyy-MM-dd'}}">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control input-sm"
									ng-model="commercial.parking" placeholder="Parking(s)">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-car"></i></span>
								<input type="text" class="form-control input-sm"
									ng-model="commercial.lift" placeholder="Lifts(s)">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<textarea class="form-control input-sm"
									ng-model="commercial.description" placeholder="Description">
                                      </textarea>
