...
<section class="content" ng-init="clientlist()">
	...
	<div class="box box-primary">
		<div class="box-header with-border">
			<h5>Edit Commercial Property</h5>
		</div>
		<div class="box-body">
			<!-- /.box-header -->
			<!-- form start -->
					...
					<div class="col-md-3">
						...
						<la
							...
							<label> <input type="radio" name="lift"
								value="Yes" id="lift_Yes" class="flat-red" checked>
							Yes
							</label> &nbsp;&nbsp;&nbsp; <label> <input type="radio"
								name="lift_No" value="No" id="lift"
								class="flat-red"> No
							</label>
						</div>
					</div> -->
						...
						<div class="form-group">
							...
							<div class="input-group">
							 ...
							 <input type="text" placeholder="Asking Price" ng-model="commercial.price" class="form-control input-sm" required="required">
                                ...
                                <select ng-model="commercial.pricein" class="form-control input-sm" required="required"  style="height: -webkit-fill-available; min-height: 16px;padding: 0;border: 0;">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group">
                                ...
                                <span class="input-group-addon" style="width: 40%;">
                                <select ng-model="commercial.areatype" class="form-control input-sm" required="required"  style="height: -webkit-fill-available; min-height: 16px;padding: 0;border: 0;">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group">
                                ...
                                <span class="input-group-addon" style="width: 40%;">
                                <select ng-model="commercial.maintenancetype" class="form-control input-sm" required="required"  style="height: -webkit-fill-available; min-height: 16px;padding: 0;border: 0;">
					...
					<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									class="form-control input-sm" ng-model="commercial.societyEntity.societyId"
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control input-sm"
									ng-model="commercial.projectname" placeholder="Society/Project Name">
